...
class ResourceServiceTest {
    ...
    void testGetResourcesByProject() {
        Resource r1 = new Resource(); r1.setId(1L); r1.setProject(Project.builder().id(2L).build());
        when(resourceRepo.findByProjectId(2L)).thenReturn(List.of(r1));

        List<ResourceDTO> result = service.getResourcesByProject(2L);
