...
public class HighlightController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<HighlightDTO> updateHighlight(@PathVariable Long id, @RequestBody HighlightDTO dto) {
        return ResponseEntity.ok(highlightService.updateHighlight(id, dto));
    }
